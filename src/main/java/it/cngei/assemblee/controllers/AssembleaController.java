...
public class AssembleaController {
  ...
  public String kickPartecipante(@PathVariable("id") Long id, @PathVariable("idUtente") Long idUtente, Principal principal) {
  ...
  @GetMapping("/{id}/presente/{idUtente}")
  public String segnaPresente(@PathVariable("id") Long id, @PathVariable("idUtente") Long idUtente, Principal principal) {
    Long me = Utils.getUserIdFromPrincipal(principal);
    assembleaService.checkIsAdmin(id, me);
    var assemblea = assembleaService.getAssemblea(id);
